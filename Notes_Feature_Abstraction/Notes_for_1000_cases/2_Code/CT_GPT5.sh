...
python -u ./batch-abstract-notes-logged.py \
  ...
  --output ../3_Outputs/ct-reports-for-1000-cases-ct-schema-gpt5.parquet \
  --note-col Text \
  --id-col EncounterCsn \
  ...
  --checkpoint-every 10 \
  --model gpt-5 \
  --json-out ../3_Outputs/ct-reports-for-1000-cases-ct-schema-gpt5.json
