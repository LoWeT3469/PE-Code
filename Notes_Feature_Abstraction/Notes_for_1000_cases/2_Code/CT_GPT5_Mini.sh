...
#SBATCH --job-name=CT_GPT5Mini_1000
...
python -u ./batch-abstract-notes-logged.py \
  ...
  --output ../3_Outputs/ct-reports-for-1000-cases-ct-schema-gpt5mini.parquet \
  --note-col Text \
  --id-col EncounterCsn \
  ...
  --checkpoint-every 10 \
  --model gpt-5-mini \
  --json-out ../3_Outputs/ct-reports-for-1000-cases-ct-schema-gpt5mini.json
