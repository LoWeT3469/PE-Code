#!/bin/bash
# Merge all Mistral 7B PE shard outputs for Notes_for_1000_cases
...
echo "=== MERGE MISTRAL 7B PE SHARDS ==="
...
files = sorted(outdir.glob("notes-for-1000-cases-pe-schema-mistral7b_shard*.parquet"))
...
out_path = outdir / "ALL_notes-for-1000-cases-pe-schema-mistral7b.parquet"
...
files = sorted(outdir.glob("notes-for-1000-cases-pe-schema-mistral7b_shard*.log.*.json"))
...
if files:
    ...
    out_path = outdir / "ALL_shard_runlogs_mistral7b_pe.json"
...
files = sorted(outdir.glob("debug-notes-for-1000-cases-pe-schema-mistral7b-job*-shard*.json"))
...
out_path = outdir / "ALL_debug_merged_mistral7b_pe.json"
with open(out_path, "w", encoding="utf-8") as f:
    json.dump(merged, f, indent=2, ensure_ascii=False)
...
echo "=== MERGE COMPLETE ==="
echo "Outputs:"
echo " - ${OUTDIR}/ALL_notes-for-1000-cases-pe-schema-mistral7b.parquet"
echo " - ${OUTDIR}/ALL_shard_runlogs_mistral7b_pe.json"
echo " - ${OUTDIR}/ALL_debug_merged_mistral7b_pe.json"